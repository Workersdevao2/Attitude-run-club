...
const translations = {
  pt: {
    ...
    // Eventos page
    'eventos.label': 'Eventos Temáticos',
    'eventos.title': 'Aqui está<br>o diferencial.',
    'eventos.sub': 'Night Runs, Fancy Runs, Story Runs e muito mais. Cada evento é uma experiência, não só um treino.',
  ...
  en: {
    ...
    // Eventos
    'eventos.label': 'Themed Events',
    'eventos.title': 'This is<br>the difference.',
    'eventos.sub': 'Night Runs, Fancy Runs, Story Runs and more. Every event is an experience, not just a workout.',
